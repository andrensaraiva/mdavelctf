      ...
      <div className="space-y-1">
        ...
        <Section id="account" icon="🔑" title="Primeira vez / Getting Started">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong>Tema visual:</strong> Em <Link to="/theme-settings" className="text-accent hover:underline">/theme-settings</Link>, escolha entre seguir o tema da turma ou usar seu tema customizado</li>
          </ul>
          <Tip>
            Quando você acessa um evento vinculado a uma turma, o tema visual muda automaticamente para combinar com a temática da turma!
          </Tip>
        </Section>
        ...
        <Section id="hints" icon="💡" title="Dicas / Hints">
          <p>
            ...
            a encontrar a flag. Mas atenção — desbloquear uma dica aplica uma <strong>penalidade em porcentagem</strong> sobre os pontos do desafio!
          </p>
          <h4 className="font-bold text-accent mt-3">Como funciona:</h4>
          <ul className="list-disc list-inside space-y-1">
            <li>Cada dica tem uma <strong>porcentagem de penalidade</strong> (ex: -20%) que reduz seus pontos no desafio</li>
            <li>As dicas são <strong>sequenciais</strong> — você precisa desbloquear a #1 antes da #2</li>
            <li>Dicas bloqueadas mostram apenas o título e a porcentagem</li>
          ...
          <div className="space-y-2">
            ...
            <Step n={2}><span>Veja a próxima dica disponível e a penalidade em %</span></Step>
          ...
          <div className="mt-3 space-y-2">
            <div className="p-3 border border-warning/20 bg-warning/5">
              <h4 className="font-bold text-warning text-sm">⚠️ Atenção à penalidade!</h4>
              <p className="text-xs mt-1">
                A porcentagem é aplicada sobre os pontos do desafio. Ex: desafio de 100pts com dica de 20% = -20pts.
        ...
        <Section id="classtypes" icon="🏷️" title="Tags e Tipos de Turma / Tags & Class Types">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Você pode escolher seguir o tema da turma ou manter seu tema customizado</li>
          ...
          <Tip>
            Se o tema mudar de repente quando você entra em um evento, é porque ele está vinculado a uma turma!
